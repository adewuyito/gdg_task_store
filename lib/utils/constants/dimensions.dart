...
const double scaffoldingPadding = 24;

final EdgeInsets safeAreaPadding = EdgeInsets.only(
  left: scaffoldingPadding.dx,
  bottom: kBottomNavigationBarHeight.dy,
  right: scaffoldingPadding.dx,
);
...
class Dims {
  const Dims._();
  // the app was designed on an iphone frame with w:h = 393:852
